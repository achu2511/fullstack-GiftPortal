        ...
        <Sidenav.Body style={{ backgroundColor: '#1d1d1d', color: 'white' }}>
          <Nav activeKey={activeKey} onSelect={setActiveKey}>
            ...
            <Nav.Menu placement="rightStart" eventKey="3" title="Products" icon={<MagicIcon />}>
              <Nav.Item eventKey="3-1"><NavLink to={'#'}>Post Products</NavLink></Nav.Item>
              <Nav.Item eventKey="3-2"><NavLink to={'#'}>Delete Products</NavLink></Nav.Item>
              <Nav.Item eventKey="3-3"><NavLink to={'#'}>Edit Products</NavLink></Nav.Item>
              <Nav.Item eventKey="3-4"><NavLink to={'#'}>View Products</NavLink></Nav.Item>
            </Nav.Menu>
